package com.github.cqrframe.widget;
...
import com.github.cqrframe.wheelpicker.R;
...
/**
 * 滑轮控件，参阅 https://github.com/florent37/SingleDateAndTimePicker
 * <p>
 * Created by liyujiang on 2018/11/5 11:53
 */
public class CqrWheelView extends View {
    ...
    protected Adapter<Item> adapter = new Adapter<>();
    private Paint paint;
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (onItemSelectedListener != null) {
                    onItemSelectedListener.onCurrentItemOfScroll(CqrWheelView.this, position);
                }
    ...
    public CqrWheelView(Context context) {
        this(context, null);
    }

    public CqrWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CqrWheelView);

        mItemTextSize = a.getDimensionPixelSize(R.styleable.CqrWheelView_wheel_item_text_size, CqrConvertUtils.sp2px(context, 14));
        mVisibleItemCount = a.getInt(R.styleable.CqrWheelView_wheel_visible_item_count, 7);
        selectedItemPosition = a.getInt(R.styleable.CqrWheelView_wheel_selected_item_position, 0);
        hasSameWidth = a.getBoolean(R.styleable.CqrWheelView_wheel_same_width, false);
        textMaxWidthPosition = a.getInt(R.styleable.CqrWheelView_wheel_maximum_width_text_position, -1);
        maxWidthText = a.getString(R.styleable.CqrWheelView_wheel_maximum_width_text);
        mSelectedItemTextColor = a.getColor(R.styleable.CqrWheelView_wheel_selected_item_text_color, -1);
        mItemTextColor = a.getColor(R.styleable.CqrWheelView_wheel_item_text_color, 0xFF888888);
        mItemSpace = a.getDimensionPixelSize(R.styleable.CqrWheelView_wheel_item_space, CqrConvertUtils.dp2px(context, 12));
        isCyclic = a.getBoolean(R.styleable.CqrWheelView_wheel_cyclic, false);
        hasIndicator = a.getBoolean(R.styleable.CqrWheelView_wheel_indicator, false);
        mIndicatorColor = a.getColor(R.styleable.CqrWheelView_wheel_indicator_color, 0xFFEE3333);
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.CqrWheelView_wheel_indicator_size, CqrConvertUtils.dp2px(context, 2));
        hasCurtain = a.getBoolean(R.styleable.CqrWheelView_wheel_curtain, false);
        mCurtainColor = a.getColor(R.styleable.CqrWheelView_wheel_curtain_color, 0x88FFFFFF);
        hasAtmospheric = a.getBoolean(R.styleable.CqrWheelView_wheel_atmospheric, false);
        isCurved = a.getBoolean(R.styleable.CqrWheelView_wheel_curved, false);
        mItemAlign = a.getInt(R.styleable.CqrWheelView_wheel_item_align, ALIGN_CENTER);
        a.recycle();
    ...
    protected List<Item> generateAdapterValues() {
    ...
    public void setDefault(Item defaultValue) {
    ...
    private void onItemSelected() {
        ...
        final Item item = this.adapter.getItem(position);
    ...
    protected void onItemSelected(int position, Item item) {
        if (listener != null) {
    ...
    protected void onItemCurrentScroll(int position, Item item) {
    ...
    public void notifyDataSetChanged() {
        ...
        if (selectedItemPosition > itemCount - 1 || currentItemPosition > itemCount - 1) {
            selectedItemPosition = currentItemPosition = itemCount - 1;
        } else {
            selectedItemPosition = currentItemPosition;
        }
        scrollOffsetY = 0;
    ...
    public interface BaseAdapter<D> {
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(CqrWheelView picker, Object data, int position);

        void onCurrentItemOfScroll(CqrWheelView picker, int position);
    }
    ...
    public interface OnWheelChangeListener {
         ...
         *
         * @param state {@link CqrWheelView#SCROLL_STATE_IDLE}
         *              {@link CqrWheelView#SCROLL_STATE_DRAGGING}
         *              {@link CqrWheelView#SCROLL_STATE_SCROLLING}
         *              <p>
         *              State of WheelPicker, only one of the following
         *              {@link CqrWheelView#SCROLL_STATE_IDLE}
    ...
    protected interface Listener {
        void onSelected(CqrWheelView view, int position, Item value);

        void onCurrentScrolled(CqrWheelView view, int position, Item value);
    }
    ...
    public static class Adapter<T extends Item> implements BaseAdapter {
        private List<T> data;
        ...
        public String getItemText(int position) {
            return data.get(position).getItemText();
        }
