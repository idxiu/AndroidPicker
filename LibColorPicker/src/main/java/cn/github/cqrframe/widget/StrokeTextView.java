package cn.github.cqrframe.widget;
...
public class StrokeTextView extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (textColor == borderColor) {
            borderColor = CqrConvertUtils.toDarkenColor(borderColor, 0.7f);
        }

        // 描外层
        setTextColorUseReflection(borderColor);
        textPaint.setStrokeWidth(CqrConvertUtils.dp2px(getContext(), borderWidth));
