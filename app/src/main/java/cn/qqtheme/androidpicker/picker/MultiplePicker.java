 ...
 * @since 2017/06/24
 */
public class MultiplePicker extends CqrConfirmPopup<MultiplePicker> {
    private List<String> items = new ArrayList<>();
    private LinearLayout layout;
    private OnItemPickListener onItemPickListener;

    public MultiplePicker(FragmentActivity activity, String[] items) {
        this(activity, Arrays.asList(items));
    }

    public MultiplePicker(FragmentActivity activity, List<String> items) {
        super(activity);
        this.items = items;
    }
    ...
    @NonNull
    @Override
    protected View createCenterView(@NonNull FragmentActivity activity) {
